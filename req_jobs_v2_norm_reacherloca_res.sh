...
#SBATCH --output=/home/ruism/projects/def-rsdjjana/ruism/Dreamer/results/reacherloca_v2_norm_res/%A-%a.out
#SBATCH --error=/home/ruism/projects/def-rsdjjana/ruism/Dreamer/results/reacherloca_v2_norm_res/%A-%a.err

set -e -o pipefail

# Top-level results dir on Lustre
BASE_SAVE_DIR="$HOME/projects/def-rsdjjana/ruism/Dreamer/results/reacherloca_v2_norm_res"
...
CKPT_PATH="/home/ruism/projects/def-rsdjjana/ruism/Dreamer/data/reacherloca_v2_norm/${SEED}/phase_1/ckpts/models.pt"
SDM_DIR="/home/ruism/projects/def-rsdjjana/ruism/Dreamer/data/reacherloca_v2_norm/${SEED}/phase_1/ckpts"

RUN_DIR="${SLURM_TMPDIR}/dreamer-v2-norm-r-${SLURM_JOB_ID:-0}-${SEED}"
...
python -u "$DREAMER_SRC/dreamer.py" \
  ...
  --algo 'Dreamerv2' \
  --exp-name 'reacherloca_v2_norm_res' \
  --train \
  --loca-all-phases \
