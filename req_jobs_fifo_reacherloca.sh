...
BASE_SAVE_DIR="$HOME/projects/def-rsdjjana/ruism/Dreamer/results/reacherloca_fifo"
...
RUN_DIR="${SLURM_TMPDIR}/dreamer-fifo-r-${SLURM_JOB_ID:-0}-${SEED}"
