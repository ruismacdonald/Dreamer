...
CKPT_PATH="${DATA_BASE}/data/reacherloca_fifo/${SEED}/phase_2/ckpts/models.pt"
...
CKPT_PATH="${DATA_BASE}/data/reacherloca_v1/${SEED}/phase_2/ckpts/models.pt"
...
CKPT_PATH="${DATA_BASE}/../Dreamer/data/reacherloca_v2/${SEED}/phase_2/ckpts/models.pt"
