...
#SBATCH --output=/home/ruism/projects/def-rsdjjana/ruism/Dreamer/results/reacherloca_v2_res/%A-%a.out
#SBATCH --error=/home/ruism/projects/def-rsdjjana/ruism/Dreamer/results/reacherloca_v2_res/%A-%a.err

set -e -o pipefail

# Top-level results dir on Lustre
BASE_SAVE_DIR="$HOME/projects/def-rsdjjana/ruism/Dreamer/results/reacherloca_v2_res"
...
CKPT_PATH="/home/ruism/projects/def-rsdjjana/ruism/Dreamer/data/reacherloca_v2/${SEED}/phase_1/ckpts/models.pt"
SDM_DIR="/home/ruism/projects/def-rsdjjana/ruism/Dreamer/data/reacherloca_v2/${SEED}/phase_1/ckpts"
